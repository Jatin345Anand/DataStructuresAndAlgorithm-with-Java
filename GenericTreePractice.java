...
public class GenericTreePractice {
    ...
    // To create Generic tree we will take first root and then will take children data..
   ...
   // System.out.println(ALMAXwithChildrenData);
	...
	// 10 4 20 2 70 0 80 2 90 0 100 0 30 1 120 0 40 2 130 0 140 1 150 0 50 3 160 0 170 0 180 1 90 0
 ...
 //	public static int sumNodewithChildren() {
//		
//	}
	static int MAX=0;
...
//		 return (TotalNumberofNodes(root1)==TotalNumberofNodes(root2))?checkIdenticalhelper(root1, root2):false;
	boolean ans=false;
...
//	  	}
	...
	public static void main(String[] args) {
	 ...
	 GTNode<Integer> root=  GT.CreateGenericTree();
